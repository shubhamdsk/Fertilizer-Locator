                    ...
                    <div class="row gx-4 gx-lg-5 align-items-center">
                        <div class="col-md-6">
                            <img class="card-img-top mb-5 mb-md-0"
                                ...
                                alt="<?php echo htmlentities($row['productName']); ?>" width="250" height="300"
                                style="border:solid 1px #000;" />

                            <img src="admin/productimages/<?php echo htmlentities($row['productImage2']); ?>" width="251"
                                style="border:solid 1px #000; margin-top: 10px;" />

                            <img src="admin/productimages/<?php echo htmlentities($row['productImage3']); ?>" width="252"
                                style="border:solid 1px #000; margin-top: 10px;" />
                        </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <img class="card-img-top"
                                src="admin/productimages/<?php echo htmlentities($row['productImage1']); ?>"
                                alt="<?php echo htmlentities($row['productName']); ?>" width="300" height="200" />
                            <!-- Product details-->
