...
<head>
    ...
    <style>
        ...
        .nav-link {
            color: #343a40;
            /* Dark gray color for navigation links */
        }
        ...
        .dropdown-menu {
            background-color: #f8f9fa;
            /* Light gray background for dropdown menu */
        }
        ...
        .dropdown-item:hover {
            color: #007bff;
            /* Change dropdown item color on hover to blue */
        }

        /* Add some spacing to the right of the badge in the cart button */
        .badge {
            margin-right: 5px;
        }
    </style>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light px-4"> <!-- Add 'px-4' class for horizontal padding -->
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="index.php">Fertilizer Shop Locater</a>
